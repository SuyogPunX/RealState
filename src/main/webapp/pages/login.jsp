...
<head>
    ...
    <title>Login - DreamHome Realty Nepal</title>
    ...
    <footer>
        <div class="footer-content">
            <div>
                ...
                <p class="footer-description">Your trusted partner in finding the perfect property in Nepal. With years of experience and a deep understanding of the Nepali real estate market, we help you make informed decisions.</p>
            ...
            <div>
                ...
                <p class="footer-contact">123 Durbar Marg</p>
                <p class="footer-contact">Kathmandu, Nepal</p>
                <p class="footer-contact">Email: info@dreamhomenepal.com</p>
                <p class="footer-contact">Phone: +977 1 4234567</p>
            </div>
        </div>
        <div class="footer-bottom">
            © 2025 DreamHome Realty Nepal. All rights reserved.
        </div>
    </footer>
