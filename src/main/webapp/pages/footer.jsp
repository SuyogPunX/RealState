    ...
    <div class="footer-content">
        <div>
            ...
            <p class="footer-description">
                Your trusted partner in finding the perfect property in Nepal. With years of experience and a deep understanding of the Nepali real estate market, we help you make informed decisions.
            </p>
        ...
        <div>
            ...
            <p class="footer-contact">Email: info@shangrilaestates.com</p>
            <p class="footer-contact">Phone: +977 1 4234567</p>
        </div>
    </div>
    <div class="footer-bottom">
        © 2025 Shangri-La Estates. All rights reserved.
    </div>
</footer>
